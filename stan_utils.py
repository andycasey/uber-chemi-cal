...
__all__ = ["read_model", "sampling_kwds", "plots"]


def read_model(path, cached_path=None, recompile=False, overwrite=True):
    r"""
    Read a Stan model from a file. If a cached file exists, use it by default.
